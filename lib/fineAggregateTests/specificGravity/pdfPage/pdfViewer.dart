...
class SpecificGravityTestPdf extends StatefulWidget {
  SpecificGravityTestPdf({Key? key}) : super(key: key);

  @override
  _SpecificGravityTestPdfState createState() => _SpecificGravityTestPdfState();
}

class _SpecificGravityTestPdfState extends State<SpecificGravityTestPdf> {
  File? file;
  @override
  void initState() {
    super.initState();
