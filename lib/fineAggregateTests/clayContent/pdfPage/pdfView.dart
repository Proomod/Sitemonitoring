...
class ClayContentTestPdf extends StatefulWidget {
  ClayContentTestPdf({Key? key}) : super(key: key);

  @override
  _ClayContentTestPdfState createState() => _ClayContentTestPdfState();
}

class _ClayContentTestPdfState extends State<ClayContentTestPdf> {
  File? file;
  @override
  void initState() {
    super.initState();
