...
class FlTestPdf extends StatefulWidget {
  const FlTestPdf({Key? key}) : super(key: key);

  @override
  _FlTestPdfState createState() => _FlTestPdfState();
}

class _FlTestPdfState extends State<FlTestPdf> {
  File? file;
  @override
  void initState() {
    super.initState();
